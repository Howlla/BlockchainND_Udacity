...
//  2) create a public setter using the inherited onlyOwner modifier 
    function setStatus(bool status) public onlyOwner{
        require(_paused!=status,"Already in this state");
        _paused=status;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to!=_tokenOwner[tokenId],"Already owned by this address");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(isApprovedForAll(_tokenOwner[tokenId], msg.sender)||msg.sender==getOwner(),"require the msg sender to be the owner of the contract or isApprovedForAll() to be true");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(ownerOf(tokenId)==from,"Token not owned by 'from' address");
